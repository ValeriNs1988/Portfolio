...
function create_portfolio_cpt() {
    $labels = array(
        ...
        'add_new_item' => __('Add New Portfolio Post', 'text_domain'),
        'edit_item' => __('Edit Portfolio Post', 'text_domain'),
...
function create_books_cpt() {
    $labels = array(
        ...
        'add_new_item' => __('Add New Book Post', 'text_domain'),
        'edit_item' => __('Edit Book Post', 'text_domain'),
...
/**
 * Cuts a string to the word closest to a given number of characters
 * Pass the string and the characters number
 */
